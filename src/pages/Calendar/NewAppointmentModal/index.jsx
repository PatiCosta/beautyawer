            ...
            <ModalBody>
              ...
              <FormControl mt={6} display='flex' alignItems='end'>
                ...
                <Select variant='flushed' id='customer' placeholder='Selecione o cliente'>
                  ...
                  <option>Patrícia Costa</option>
                  <option>Fernando Fenólio</option>
                  <option>Raphael Souza</option>
                  <option>Victória Andrade</option>
                  <option>Lucas Camargo</option>
                </Select>
              </FormControl>
              <Text mt={8} fontWeight='semibold' color='cadetBlue.500' fontSize={{sm: 'sm', md: 'md'}}>Serviços</Text>
              <JobsCheckbox 
